...
| 5 | `ADM-OPS-010` | `adm-operators` | 운영자 및 권한 관리 | 운영과 관리 |
...
- 더미 행:
  ...
  ADM-OPS-010 / adm-operators / AdmOperators / ⚪ 대기
- 캡션:
  "상태: ⚪대기 → 🟡코딩중 → 🔵로컬검증 → ●배포완료"
...
- 카드 그리드 5개:
  ...
  6. "운영과 관리" / adm-operators / [이동] data-action="go-adm-operators"
- 각 카드에는 작은 설명:
...
이로써 관리자 V3.0 Stitch 프롬프트 세트는 UI 설계 산출물의 운영자 관리 화면을 포함해 다음 11개 화면으로 완성됩니다.
